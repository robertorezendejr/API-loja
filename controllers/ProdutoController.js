        ...
        try {
            ...
            if( categoria && categoria.toString() !== produto.categoria.toString() ){
                ...
                if(oldCategoria && newCategoria){
                    oldCategoria.produtos = oldCategoria.produtos.filter(item => item !==produto._id /* item.toString() !== produto._id.toString() */);
    ...
    async show(req,res,next){
        try {
            const produto = await Produto
                ...
                .populate(["avaliacoes", "variacoes", "loja"/* , "categoria" */]);
            return res.send({ produto });
        } catch(e){
            next(e);
        }
